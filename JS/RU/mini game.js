...
MiniGame_button.innerHTML = `
    <div class="game-button-container">
        ...
        <button type="button" class="game-button" data-bs-toggle="modal" data-bs-target="#GameModal">
            ...
            <span class="button-text">Мини-игра</span>
        </button>
    </div>
`;
        ...
        <div class="modal-content game-modal">
            <div class="modal-header">
                <h5 class="modal-title" id="MiniGame_ID">
                    <span class="game-icon">🎮</span> Космический Ping Pong
                </h5>
            ...
            <div class="modal-body">
                <div class="game-container">
                    ...
                    <div class="controls-info">
                        <p>Управление: ← → или A D или мышкой</p>
                    </div>
...
class Game {
    ...
    draw() {
        ...
        if (this.isGameOver) {
            ...
            this.ctx.font = '24px "Press Start 2P", cursive';
            this.ctx.fillText(`Финальный счет: ${this.score}`, this.width / 2, this.height / 2 + 50);
        }
    }
