...
MiniGame_button.innerHTML = `
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#GameModal">🎮 Mini-game</button>
`;
...
<div class="modal-content bg-dark">
    <div class="modal-header">
        <h5 class="modal-title" id="MiniGame_ID">🎮 Mini-game</h5>
        <button type="button" class="btn-close bg-light" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div>
        <button id="PlayButton" class="btn btn-primary" onclick="play()">Play</button>
        <p style="text-align: center;">Control: <-, -> or A, D</p>
...
function drawGameOver () {
    ...
    ctx.fillStyle = "rgb(255,255,255)";
    ctx.fillText("GAME OVER", (CanvasWidth - 100)/2, CanvasHeight/2, 100);
}
